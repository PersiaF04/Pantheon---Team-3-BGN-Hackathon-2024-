...
const App = () => {
    ...
    const isSpecialPage = isProfilePage || isLinguisticsPage || isFAQPage || isHelpPage || loginPage || searchResult || isVideoDetailPage || isArticleDetailPage || isDiscussionDetailPage;
